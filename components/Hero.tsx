...
function Hero() {
  return (
    <section className="flex flex-col-reverse md:flex-row justify-center items-center w-screen mx-auto pt-10">
      ...
      <div className=" bg-opacity-60 flex justify-center items-end -mb-8 z-10">
        <h1 className=" align-middle text-md md:text-lg lg:text-xl max-w-prose tracking-wider leading-relaxed text-justify px-5">
