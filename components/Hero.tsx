...
function Hero() {
  return (
    <section className="flex flex-col-reverse md:flex-row justify-center items-center w-screen mx-auto pt-8 md:py-20 md:px-10 md:h-screen">
      <div className="md:basis-1/2 flex justify-center items-start w-full md:py-10">
        <div
        ...
        via-transparent via-30% to-transparent md:bg-none md:w-f md:-mr-4">
            <Image
              className="w-screen -z-10 relative md:w-full md:rounded-l-xl md:h-full md:object-fill md:-mr-1"
              src="/pool-img.jpeg"
              height={300}
              width={300}
              alt=""
      ...
      <div className=" bg-opacity-60 flex justify-center items-end -mb-14 z-10 md:basis-1/2 md:mb-0 md:bg-cyan-800 md:h-fit md:z-0 md:py-28 md:mr-4 md:rounded-r-lg md:-ml-2">
